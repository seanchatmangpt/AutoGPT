...
def convert_to_task(task_obj: TaskModel, debug_enabled: bool = True) -> Task:
    if debug_enabled:
...
def convert_to_step(step_model: StepModel, debug_enabled: bool = True) -> Step:
    if debug_enabled:
...
class AgentDB:
    def __init__(self, database_string, debug_enabled: bool = True) -> None:
        super().__init__()

...
import agent.openapi_client.models
from agent.openapi_client import rest
from agent.openapi_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(agent.openapi_client.models, klass)

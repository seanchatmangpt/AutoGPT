...
def generate_module_pages(yaml_data):
    ...
    for class_name, class_info in yaml_data.items():
        ...
        with open(f"pages/{class_name}.html", "w") as html_file:
...
def module(module_name):
    # Load the specific module HTML page
    with open(f"pages/{module_name}", "r") as module_file:
        module_html = module_file.read()

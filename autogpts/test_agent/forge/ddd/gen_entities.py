...
class EntityTemplate(TypedTemplate):
    ...
    source = """
from ddd.value_objects.{{ value_object|underscore  }} import {{ value_object }}
...
class AggregateRootTemplate(TypedTemplate):
    ...
    source = """
from ddd.entities.{{ entity_name|underscore  }} import {{ entity_name }}
...
class RepositoryTemplate(TypedTemplate):
    class_name: str = ""
    entity_name: str = ""
    to: str = "./ddd/repositories/{{ class_name }}_repo.py"
    source = """
from ddd.entities.{{ entity_name|underscore }} import {{ entity_name }}
...
class ServiceTemplate(TypedTemplate):
    ...
    source = """
from ddd.repositories.{{ repository_name|underscore  }}_repo import {{ repository_name }}Repo

...
env = setup_jinja_environment(get_project_root() + "/ddd/templates")
...
if __name__ == "__main__":
    # Load YAML content
    with open("interview_domain.yaml", "r") as file:
